      ...
      <div className="bg-white rounded-2xl shadow-lg p-10 w-full max-w-md text-center">
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-5 py-3 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 transition font-medium text-slate-700"
            >
